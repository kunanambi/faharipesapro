...
import { LayoutDashboard, CreditCard, Users, Video, DollarSign, Landmark, Cog, Settings } from "lucide-react";
...
const navItems = [
  ...
  { href: "/admin/pending-settings", icon: Settings, label: "Pending" },
];
