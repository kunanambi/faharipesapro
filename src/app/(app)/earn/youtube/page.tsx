...
export default async function EarnYouTubePage() {
    const supabase = createClient();
    ...
    const earnOptions = await getUnwatchedAds(user.id, 'youtube');
    ...
    return (
        <div className="space-y-6">
            <div>
                <h1 className="font-headline text-3xl font-bold">YouTube Videos</h1>
                <p className="text-muted-foreground">Watch YouTube videos to earn money.</p>
            </div>
                ...
                <Card>
                    <CardContent className="pt-6">
                        <div className="flex flex-col items-center justify-center h-48 text-center">
                            ...
                            <p className="font-semibold text-lg">No New YouTube Videos</p>
